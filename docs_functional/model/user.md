...
_Source: https://shopizer-ecommerce.github.io/documentation/model/user.html_
...
**USER****MERCHANT_STORE****SM_GROUP****USER_GROUP****PERMISSION_GROUP****PERMISSION**

Users belong to MERCHANT_STORE. Users are assigned to groups having predefined sets of permissions.

![User database tables](https://shopizer-ecommerce.github.io/documentation/assets/users.684522f6.png)
